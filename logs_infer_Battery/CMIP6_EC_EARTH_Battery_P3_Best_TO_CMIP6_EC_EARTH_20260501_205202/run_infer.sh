...
LOG_FILE="/home/exouser/Documents/PACT-Data/Emulator/logs_infer_Battery/CMIP6_EC_EARTH_Battery_P3_Best_TO_CMIP6_EC_EARTH_20260501_205202/infer_${STATION}_CMIP6_${MODEL}_hist${HISTORY_HOURS}h_20260501_205202.log"
: > "${LOG_FILE}"
...
"${PYTHON_BIN}" -u "${INFER_PY}" \
  ...
  --ckpt "${CKPT_RESOLVED}" \
  --out_dir "/home/exouser/Documents/PACT-Data/Emulator/logs_infer_Battery/CMIP6_EC_EARTH_Battery_P3_Best_TO_CMIP6_EC_EARTH_20260501_205202/outputs" \
  --save_npz \
  "${YEARS_ARGS[@]}" \
  "${AMP_ARGS[@]}" \
  "${TF32_ARGS[@]}" \
...
echo "[DONE] outputs in: /home/exouser/Documents/PACT-Data/Emulator/logs_infer_Battery/CMIP6_EC_EARTH_Battery_P3_Best_TO_CMIP6_EC_EARTH_20260501_205202/outputs" | tee -a "${LOG_FILE}"
