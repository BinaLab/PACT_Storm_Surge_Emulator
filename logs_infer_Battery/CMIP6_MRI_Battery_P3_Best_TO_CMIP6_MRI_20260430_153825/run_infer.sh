...
source "configs/configs_infer/infer_config_MRI.sh"
set -u
...
LOG_FILE="/home/exouser/Documents/PACT-Data/Emulator/logs_infer_Battery/CMIP6_MRI_Battery_P3_Best_TO_CMIP6_MRI_20260430_153825/infer_${STATION}_CMIP6_${MODEL}_hist${HISTORY_HOURS}h_20260430_153825.log"
: > "${LOG_FILE}"
...
"${PYTHON_BIN}" -u "${INFER_PY}" \
  ...
  --ckpt "${CKPT_RESOLVED}" \
  --out_dir "/home/exouser/Documents/PACT-Data/Emulator/logs_infer_Battery/CMIP6_MRI_Battery_P3_Best_TO_CMIP6_MRI_20260430_153825/outputs" \
  --save_npz \
  "${YEARS_ARGS[@]}" \
  "${AMP_ARGS[@]}" \
  "${TF32_ARGS[@]}" \
...
echo "[DONE] outputs in: /home/exouser/Documents/PACT-Data/Emulator/logs_infer_Battery/CMIP6_MRI_Battery_P3_Best_TO_CMIP6_MRI_20260430_153825/outputs" | tee -a "${LOG_FILE}"
