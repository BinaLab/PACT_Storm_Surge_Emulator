...
# =========================
USE_PMEAN=1               # 0/1 (maps to --use_pmean)
PMEAN_DIM=32              # maps to --pmean_dim (baseline and perceiver global branch)
PERCEIVER_PMEAN_MODE="global"  # tokens | global | both  (only used when MODEL=perceiver3 AND USE_PMEAN=1)

# =========================
# Loss knobs
# =========================
LOSS_MODE_LIST=("wmse" "mse_tail" "wmse_tail" "mse_wtail" "mse_slope" "wmse_slope" "mse_tail_slope" "wmse_tail_slope" "mse_wtail_slope")    # ("mse" "wmse" "mse_tail" "wmse_tail" "mse_wtail" and add suffix *_slope)

TAIL_FRAC="0.05"
TAIL_LAMBDA_LIST=("0.10" "1.0")
...
# =========================
SLOPE_LAMBDA_LIST=("0.01" "0.10")   # maps to --slope_lambda
