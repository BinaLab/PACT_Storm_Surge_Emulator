...
# =========================
num_gpus=4
ROOT_DIR="./Data/Grid4_New_PastOnly/CMIP6_Cane5/graphs"
...
# Loss knobs
# =========================
LOSS_MODE_LIST=("mse_tail_slope")    # ("mse" "wmse" "mse_tail" "wmse_tail" "mse_wtail" and add suffix *_slope)
...
# =========================
SLOPE_LAMBDA_LIST=("0.10")   # maps to --slope_lambda
