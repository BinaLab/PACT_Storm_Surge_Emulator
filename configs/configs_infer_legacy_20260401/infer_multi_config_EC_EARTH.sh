...
INFER_PY="infer.py"
CKPT_PATH="./Inference_Checkpoints/CMIP6_EC_EARTH_Battery_P3_Best.pth"   # can be a file OR a glob pattern
...
RUNS=(
  ...
  "CMIP6_EC_EARTH_Battery_P3_Best_TO_CMIP6_Cane5|./Data/Grid4_New/CMIP6_Cane5/graphs"
)
