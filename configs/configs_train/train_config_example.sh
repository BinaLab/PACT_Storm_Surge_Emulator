...
# Train script
# =========================
TRAIN_PY="train_clean_step4_pmean_modes_slope.py"   # <-- set this to your CURRENT big train file (e.g., train_clean_step4_pmean_modes.py)

# =========================
# GPU / data
# =========================
num_gpus=4
ROOT_DIR="./Data/CMIP6_CNRM/graphs"
...
SEED=42
MODEL="baseline"          # baseline | perceiver3
